...
@Component({
  selector: 'app-nice-expansion-panel',
  templateUrl: './nice-expansion-panel.html',
  styleUrls: ['./nice-expansion-panel.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class NiceExpansionPanelComponent implements OnInit {
